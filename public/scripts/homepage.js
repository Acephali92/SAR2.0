...
// Newsletter form handling (prevent page reload)
const newsletterForm = document.getElementById('newsletter-form');
newsletterForm?.addEventListener('submit', async (e) => {
  e.preventDefault();
  const form = e.target;
  const _email = new FormData(form).get('email'); // TODO: Use for actual API call
  ...
  try {
    ...
    if (submitBtn) {
      ...
      submitBtn.classList.remove('bg-brand-red', 'hover:bg-brand-red-hover');
    ...
    setTimeout(() => {
      if (submitBtn) {
        ...
        submitBtn.classList.add('bg-brand-red', 'hover:bg-brand-red-hover');
